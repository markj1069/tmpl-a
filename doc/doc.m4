...
define(`dc_creator', `dc_creator_given dc_creator_family')dnl
define(`dc_creator_jobTitle', `Independent Scholar')
define(`dc_keyword_1', `N/A')dnl
define(`dc_keyword_2', `N/A')dnl
define(`dc_keyword_3', `N/A')dnl
...
define(`dc_type', `Text')dnl  # Select one
define(`dc_source', `N/A')dnl
...
define(`dc_format', `text/markdown')dnl
define(`dc_format_extent', `(N/A)')dnl
define(`dc_format_medium', `text')dnl
